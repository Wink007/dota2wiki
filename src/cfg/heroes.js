    ...
    },
    {
        ...
        skills: [
            ...
            },
            {
                ...
                description: 'Позволяет синтезировать больше золота из врагов и рун. Дополнительное золото за убийство существ состоит из начального бонуса и нарастающего, который увеличивается с каждым существом, убитым в течение %duration% сек. после предыдущего. Также способность умножает золото от рун богатства',
            },
            {
    ...
    },
    {
        ...
        skills: [
            ...
            },
            {
                ...
                description: 'ПРЕРЫВАЕМАЯ — захватывает врага, оглушая его и нанося большой периодический урон. Также жертва каждые %fiend_grip_tick_interval% сек. теряет долю от максимального запаса маны, передавая её владельцу способности.',
            },
        ],
    ...
    },
    {
        ...
        skills: [
            ...
            },
            {
                ...
                description: 'Герой окропляет выбранную область святой кровью. Через %delay_plus_castpoint_tooltip% сек. ритуал завершается, нанося противникам урон и запрещая им применять способности.',
            },
            {
    ...
    },
    {
        ...
        skills: [
            ...
            },
            {
                ...
                description: 'Герой создает свою огненную копию, которая бежит к указанному месту со скоростью в 2,5 раза большей скорости героя. На это расходуется один из %max_charges% зарядов способности, которые восстанавливаются по %charge_restore_time% секунд. Используя способность Activate Fire Remnant, герой может быстро переместиться по всем копиям, отчего они взорвутся и нанесут урон противникам. Выбранная копия будет конечной целью полёта.',
            },
        ],
